...
const Contact = () => {
    ...
    const {
        title = "Get in Touch",
        subtitle = "Interested in wholesale pricing or have questions about our products? We're here to help."
    } = content.contact || {};
        ...
        <div className="bg-cream py-20 px-4 overflow-hidden sm:px-6 lg:px-8" id="contact">
            <div className="relative max-w-xl mx-auto">
                <div className="text-center">
                    <h2 className="text-4xl font-bold tracking-tight text-primary sm:text-5xl font-serif">{title}</h2>
