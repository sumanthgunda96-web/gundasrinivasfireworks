...
const Hero = () => {
    ...
    const {
        ...
        heroSubtitle = "Celebrations",
        heroDescription = "Premium wholesale fireworks and seasonal goods. From sparklers to spectacular displays, we bring joy to every celebration.",
        heroButtonText = "Browse Collection"
    } = content.home || {};
