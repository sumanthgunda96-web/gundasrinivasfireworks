...
const AdminOrders = () => {
    ...
    const { subscribeToAllOrders, updateAdminOrderStatus } = useOrders();
    ...
    useEffect(() => {
        ...
        // Real-time listener via service
        ...
        return unsubscribe;
    }, [currentUser, navigate]); // Removed subscribeToAllOrders from deps to avoid re-subscription loop if context ref unstables

    const updateOrderStatus = async (orderId, newStatus) => {
        try {
            await updateAdminOrderStatus(orderId, newStatus);
            // alert(`Order status updated to: ${newStatus}`); // Optional: Notifications are better
        } catch (error) {
